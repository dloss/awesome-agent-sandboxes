...
- [Mitos](https://github.com/mitos-run/mitos) - Kubernetes-native runtime that live copy-on-write forks a running Firecracker microVM into N self-hostable, isolated sandboxes for AI agents
